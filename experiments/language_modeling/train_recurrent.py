...
from recurrent_model import LitRecurrentTransformerLM, get_experiment_name
...
train_config.limit_test_batches = getattr(train_config, 'limit_test_batches', 20) # number of microbatches to use for testing
...
# if limit_train_batches is set, limit the number of training steps
...
trainer_kwargs = dict(
    ...
    val_check_interval=train_config.val_check_interval, # interval (in steps, not microsteps) to check validation
    limit_val_batches=train_config.limit_val_batches, # number of batches to use for validation
    limit_test_batches=train_config.limit_test_batches, # number of batches to use for testing
